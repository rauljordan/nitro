...
func TestPassingBlockNumber(t *testing.T) {
	...
	bc := NewBoundContract(common.HexToAddress("0x0"), abi.ABI{
	...
	bc.Call(&CallOpts{BlockNumber: blockNumber}, nil, "something")
	...
	bc.Call(&CallOpts{}, nil, "something")
	...
	bc.Call(&CallOpts{BlockNumber: blockNumber, Pending: true}, nil, "something")
...
func TestUnpackIndexedStringTyLogIntoMap(t *testing.T) {
	...
	bc := NewBoundContract(common.HexToAddress("0x0"), parsedAbi, nil, nil, nil)
...
func TestTransactGasFee(t *testing.T) {
	...
	bc := NewBoundContract(common.Address{}, abi.ABI{}, nil, mt, nil)
	opts := &TransactOpts{Signer: mockSign}
...
func unpackAndCheck(t *testing.T, bc *BoundContract, expected map[string]interface{}, mockLog types.Log) {
...
func TestCall(t *testing.T) {
	...
	tests := []struct {
		...
		method:       method,
		wantErrExact: ErrNoPendingState,
	}, {
